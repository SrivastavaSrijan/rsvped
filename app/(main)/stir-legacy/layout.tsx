...
import { StirSearch } from '@/app/(main)/stir-legacy/components'
import { StirSlotSwitch } from '@/app/(main)/stir-legacy/components/StirSlotSwitch'
import { StirSuggestionChips } from '@/app/(main)/stir-legacy/components/StirSuggestionChips'
import { StirTabsHeader } from '@/app/(main)/stir-legacy/components/StirTabsHeader'
