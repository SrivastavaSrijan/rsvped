...
export const AuthActionErrorCodeMap: Record<AuthErrorCodes, string> = {
	...
	[AuthErrorCodes.UNEXPECTED_ERROR]:
...
export const EventActionErrorCodeMap: Record<EventErrorCodes, string> = {
	...
	[EventErrorCodes.UNEXPECTED_ERROR]:
		'An unexpected error occurred. Please try again later.',
...
export const LocationActionErrorCodeMap: Record<
	LocationUpdateActionErrorCode,
	string
> = {
	[LocationUpdateActionErrorCode.SERVER_ERROR]:
		'An unexpected error occurred. Please try again.',
	[LocationUpdateActionErrorCode.FORBIDDEN]:
